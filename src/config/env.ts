...
const envSchema = z.object({
  ...
  MEDIA_MAX_WIDTH: z.coerce.number().int().positive().max(100_000).default(12_000),
  MEDIA_MAX_HEIGHT: z.coerce.number().int().positive().max(100_000).default(12_000),
  MEDIA_MAX_FRAMES: z.coerce.number().int().positive().max(10_000).default(100),
  MEDIA_PROCESSING_CONCURRENCY: z.coerce.number().int().positive().max(32).default(2),
